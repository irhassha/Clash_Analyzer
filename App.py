    ...
    if st.session_state.get('processed_df') is not None:
        ...
        if forecast_df is not None and not forecast_df.empty:
            ...
            if not upcoming_vessels_df.empty:
                ...
                # MODIFICATION: Round 'Next Loading Prediction' to the nearest integer
                summary_df['Next Loading Prediction'] = summary_df['Next Loading Prediction'].fillna(0).round(0).astype(int)
                
                # MODIFICATION: Calculate 'Difference'
