...
def apply_all_styles(df, selected_dates):
    """Menerapkan style fade dan highlight."""
    ...
    # Perbarui daftar kolom yang tidak termasuk cluster
    ...
    for r_idx in df.index:
        for c_name in df.columns:
            ...
            # Pastikan kolom clash ada sebelum diakses
...
def general_formatter(val):
    """Format angka: sembunyikan 0, tampilkan sebagai integer."""
    ...
    if schedule_file and unit_list_file and (df_vessel_codes is not None and not df_vessel_codes.empty):
        with st.spinner('Loading and processing data...'):
            try:
                ...
                # --- PERUBAHAN 1: Hitung Total Box dan Total Cluster ---
                ...
                # 5. Conditional Filtering (menggunakan 'Total Box')
